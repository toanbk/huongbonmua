(function(blocks, i18n, element) {
	...
	blocks.registerBlockType(
		...
		trx_addons_apply_filters( 'trx_addons_gb_map', {
			...
			keywords: [ 'team', 'staff', 'member', 'emploee' ],
			icon: 'groups',
				...
				return trx_addons_gutenberg_block_params(
					{
						...
						'general_params': el( wp.element.Fragment, {},
							trx_addons_gutenberg_add_params( trx_addons_apply_filters( 'trx_addons_gb_map_add_params', [
								...
								{
									'name': 'parent_post',
									'title': __( "Parent post (Command)", "trx_addons" ),
									'descr': __( "Select a parent post (if need)", "trx_addons" ),
									'type': 'select',
									'options': trx_addons_gutenberg_get_lists( TRX_ADDONS_STORAGE['gutenberg_sc_params']['sc_team_parent_posts'][ TRX_ADDONS_STORAGE['gutenberg_sc_params']['sc_team_parent_post_types'][post_type] ] )
								},
								// Taxonomy
								{
									'name': 'taxonomy',
