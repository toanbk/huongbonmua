...
if ( ! function_exists( 'hot_coffee_woocommerce_get_css' ) ) {
	add_filter( 'hot_coffee_filter_get_css', 'hot_coffee_woocommerce_get_css', 10, 2 );
	function hot_coffee_woocommerce_get_css( $css, $args ) {
...
$fdir = hot_coffee_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
