...
if ( ! function_exists( 'hot_coffee_tribe_events_get_css' ) ) {
	add_filter( 'hot_coffee_filter_get_css', 'hot_coffee_tribe_events_get_css', 10, 2 );
	function hot_coffee_tribe_events_get_css( $css, $args ) {
