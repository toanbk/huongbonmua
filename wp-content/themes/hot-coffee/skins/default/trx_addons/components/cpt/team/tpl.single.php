...
while ( have_posts() ) { the_post();
	...
	$hot_coffee_cpt_team_article_info_output = '';
	ob_start();
		...
		<div class="team_member_details">
			...
			if ( $need_info ) {
				...
				<div class="team_member_brief_info">
					<h3 class="section_title team_member_brief_info_title"><?php esc_attr_e('Biography', 'hot-coffee'); ?></h3>
	...
	$hot_coffee_cpt_team_article_info_output = ob_get_contents();
	ob_end_clean();

	do_action('trx_addons_action_after_article', 'team.single', $hot_coffee_cpt_team_article_info_output);
