...
Please install and activate it before starting to use the theme Hot Coffee.
...
Theme documentation is available on http://hotcoffee.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Hot Coffee is Fontello.
